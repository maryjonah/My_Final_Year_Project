...
<div id="container">
  ...
  if (isset($_SESSION['username'])) {
   echo  '<p><a href = "displayfinaltimetable.php" style = "color:blue;text-align:center;font-size:15px;">
	TIMETABLE PAGE</a></p>';
...
?>
  ...
  <p style = "width:300px;margin:0 0 0 0;padding: 0 0 0 0;">Search With Departments</p>
	...
	<form action="finaladvancedSearchResults.php" method="GET" id = "departments" name = "departments" style= "width=300px" >
	...
	<form action="finaladvancedSearchLevels.php" method="GET" id = "levels" name = "levels" style="float:right;margin-right:60px;color:white;">
	...
	<form action="finalsearchCourse.php" method="GET" id = "levels" name = "levels" style="float:right;margin-right:60px;">
